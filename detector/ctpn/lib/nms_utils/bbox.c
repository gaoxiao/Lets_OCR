...
#define __PYX_HAVE__nms_utils__bbox
#define __PYX_HAVE_API__nms_utils__bbox
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 * def bbox_overlaps(
 */
typedef __pyx_t_5numpy_float_t __pyx_t_9nms_utils_4bbox_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'nms_utils.bbox' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_9nms_utils_4bbox_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_9nms_utils_4bbox_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "nms_utils.bbox"
extern int __pyx_module_is_main_nms_utils__bbox;
int __pyx_module_is_main_nms_utils__bbox = 0;

/* Implementation of 'nms_utils.bbox' */
...
static const char __pyx_k_nms_utils_bbox[] = "nms_utils.bbox";
...
static PyObject *__pyx_n_s_nms_utils_bbox;
...
static PyObject *__pyx_pf_9nms_utils_4bbox_bbox_overlaps(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes); /* proto */
static PyObject *__pyx_pf_9nms_utils_4bbox_2bbox_intersections(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_9nms_utils_4bbox_1bbox_overlaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9nms_utils_4bbox_bbox_overlaps[] = "\n    Parameters\n    ----------\n    boxes: (N, 4) ndarray of float\n    query_boxes: (K, 4) ndarray of float\n    Returns\n    -------\n    overlaps: (N, K) ndarray of overlap between boxes and query_boxes\n    ";
static PyMethodDef __pyx_mdef_9nms_utils_4bbox_1bbox_overlaps = {"bbox_overlaps", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9nms_utils_4bbox_1bbox_overlaps, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9nms_utils_4bbox_bbox_overlaps};
static PyObject *__pyx_pw_9nms_utils_4bbox_1bbox_overlaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nms_utils.bbox.bbox_overlaps", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_9nms_utils_4bbox_bbox_overlaps(__pyx_self, __pyx_v_boxes, __pyx_v_query_boxes);
...
static PyObject *__pyx_pf_9nms_utils_4bbox_bbox_overlaps(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes) {
  unsigned int __pyx_v_N;
  unsigned int __pyx_v_K;
  PyArrayObject *__pyx_v_overlaps = 0;
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_v_iw;
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_v_ih;
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_v_box_area;
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_v_ua;
  unsigned int __pyx_v_k;
  unsigned int __pyx_v_n;
  ...
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_t_23;
  size_t __pyx_t_24;
  Py_ssize_t __pyx_t_25;
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_t_26;
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_t_27;
  size_t __pyx_t_28;
  Py_ssize_t __pyx_t_29;
  size_t __pyx_t_30;
  Py_ssize_t __pyx_t_31;
  __pyx_t_9nms_utils_4bbox_DTYPE_t __pyx_t_32;
  int __pyx_t_33;
  size_t __pyx_t_34;
  ...
  __pyx_pybuffernd_query_boxes.rcbuffer = &__pyx_pybuffer_query_boxes;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_boxes.rcbuffer->pybuffer, (PyObject*)__pyx_v_boxes, &__Pyx_TypeInfo_nn___pyx_t_9nms_utils_4bbox_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 16, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_query_boxes.rcbuffer->pybuffer, (PyObject*)__pyx_v_query_boxes, &__Pyx_TypeInfo_nn___pyx_t_9nms_utils_4bbox_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 16, __pyx_L1_error)
  }
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_overlaps.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_9nms_utils_4bbox_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 *         )
 */
    __pyx_v_box_area = ((((*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_query_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_query_boxes.diminfo[1].strides))) + 1.0) * (((*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_query_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_query_boxes.diminfo[1].strides))) + 1.0));

    /* "nms_utils/bbox.pyx":39
 *             (query_boxes[k, 3] - query_boxes[k, 1] + 1)
 *         )
 *         for n in range(N):             # <<<<<<<<<<<<<<
 *             iw = (
 ...
 */
      ...
      __pyx_t_23 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
      ...
      __pyx_t_26 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_25, __pyx_pybuffernd_boxes.diminfo[1].strides));
 ...
 */
      ...
      __pyx_t_23 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_29, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
      ...
      __pyx_t_26 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_31, __pyx_pybuffernd_boxes.diminfo[1].strides));
      if (((__pyx_t_23 > __pyx_t_26) != 0)) {
 ...
 */
        ...
        __pyx_t_32 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_35, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
        ...
        __pyx_t_27 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_37, __pyx_pybuffernd_boxes.diminfo[1].strides));
 ...
 */
        ...
        __pyx_t_32 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_39, __pyx_pybuffernd_query_boxes.diminfo[1].strides));
        ...
        __pyx_t_27 = (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_41, __pyx_pybuffernd_boxes.diminfo[1].strides));
        if (((__pyx_t_32 > __pyx_t_27) != 0)) {
 ...
 *                         (boxes[n, 3] - boxes[n, 1] + 1) +
 */
          __pyx_v_ua = ((double)((((((*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_42, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_43, __pyx_pybuffernd_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_45, __pyx_pybuffernd_boxes.diminfo[1].strides))) + 1.0) * (((*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_47, __pyx_pybuffernd_boxes.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_48, __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_49, __pyx_pybuffernd_boxes.diminfo[1].strides))) + 1.0)) + __pyx_v_box_area) - (__pyx_v_iw * __pyx_v_ih)));

          /* "nms_utils/bbox.pyx":55
 *                         box_area - iw * ih
 *                     )
 ...
 */
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.buf, __pyx_t_50, __pyx_pybuffernd_overlaps.diminfo[0].strides, __pyx_t_51, __pyx_pybuffernd_overlaps.diminfo[1].strides) = (__pyx_t_26 / __pyx_v_ua);
...
/* Python wrapper */
static PyObject *__pyx_pw_9nms_utils_4bbox_3bbox_intersections(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9nms_utils_4bbox_2bbox_intersections[] = "\n    For each query box compute the intersection ratio covered by boxes\n    ----------\n    Parameters\n    ----------\n    boxes: (N, 4) ndarray of float\n    query_boxes: (K, 4) ndarray of float\n    Returns\n    -------\n    overlaps: (N, K) ndarray of intersec between boxes and query_boxes\n    ";
static PyMethodDef __pyx_mdef_9nms_utils_4bbox_3bbox_intersections = {"bbox_intersections", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9nms_utils_4bbox_3bbox_intersections, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9nms_utils_4bbox_2bbox_intersections};
static PyObject *__pyx_pw_9nms_utils_4bbox_3bbox_intersections(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_boxes = 0;
  PyArrayObject *__pyx_v_query_boxes = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nms_utils.bbox.bbox_intersections", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_9nms_utils_4bbox_2bbox_intersections(__pyx_self, __pyx_v_boxes, __pyx_v_query_boxes);
...
static PyObject *__pyx_pf_9nms_utils_4bbox_2bbox_intersections(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes) {
  unsigned int __pyx_v_N;
  unsigned int __pyx_v_K;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_boxes.rcbuffer->pybuffer, (PyObject*)__pyx_v_boxes, &__Pyx_TypeInfo_nn___pyx_t_9nms_utils_4bbox_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 58, __pyx_L1_error)
  }
  __pyx_pybuffernd_boxes.diminfo[0].strides = __pyx_pybuffernd_boxes.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_boxes.diminfo[0].shape = __pyx_pybuffernd_boxes.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_boxes.diminfo[1].strides = __pyx_pybuffernd_boxes.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_boxes.diminfo[1].shape = __pyx_pybuffernd_boxes.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_query_boxes.rcbuffer->pybuffer, (PyObject*)__pyx_v_query_boxes, &__Pyx_TypeInfo_nn___pyx_t_9nms_utils_4bbox_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 58, __pyx_L1_error)
  }
  __pyx_pybuffernd_query_boxes.diminfo[0].strides = __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_query_boxes.diminfo[0].shape = __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_query_boxes.diminfo[1].strides = __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_query_boxes.diminfo[1].shape = __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.shape[1];

  /* "nms_utils/bbox.pyx":72
 *     overlaps: (N, K) ndarray of intersec between boxes and query_boxes
 *     """
 *     cdef unsigned int N = boxes.shape[0]             # <<<<<<<<<<<<<<
 *     cdef unsigned int K = query_boxes.shape[0]
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_intersec.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_9nms_utils_4bbox_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_9nms_utils_4bbox_DTYPE_t *, __pyx_pybuffernd_intersec.rcbuffer->pybuffer.buf, __pyx_t_42, __pyx_pybuffernd_intersec.diminfo[0].strides, __pyx_t_43, __pyx_pybuffernd_intersec.diminfo[1].strides) = (__pyx_t_26 / __pyx_v_box_area);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_nms_utils_bbox, __pyx_k_nms_utils_bbox, sizeof(__pyx_k_nms_utils_bbox), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_nms_utils__bbox) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nms_utils.bbox")) {
      if (unlikely(PyDict_SetItemString(modules, "nms_utils.bbox", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         np.ndarray[DTYPE_t, ndim=2] query_boxes):
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_9nms_utils_4bbox_1bbox_overlaps, NULL, __pyx_n_s_nms_utils_bbox); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *         np.ndarray[DTYPE_t, ndim=2] query_boxes):
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_9nms_utils_4bbox_3bbox_intersections, NULL, __pyx_n_s_nms_utils_bbox); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bbox_intersections, __pyx_t_2) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "nms_utils/bbox.pyx":1
 * # --------------------------------------------------------             # <<<<<<<<<<<<<<
 * # Fast R-CNN
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init nms_utils.bbox", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nms_utils.bbox");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
